...
tcpstreams = []
SSLLOGFILEPATH = "C:\\Users\\ASUS\\Desktop\\Project\\ssl1.log" # "C:\\Users\\sengu\\ssl1.log"
http2streams=[]
logdecodedtls = True
httpobjectindexes = []
httpobjectactuals = []
...
while True:
    ...
    if event == '-savepcap-':
        pcapname = "nettrafic"
        scp.wrpcap(f'C:\\Users\\ASUS\\Desktop\\Project\\savedpcap\\{pcapname}.pcap', inc_pkt_list)
        #C:\\Users\\ASUS\\Desktop\\Project\\ssl1.log
    if event == '-pkts-' and len(values['-pkts-']):     # if a list item is chosen
        sus_selected = values['-pkts-']
        #sus_selected_index = int(sus_selected.split()[0][0:2])
